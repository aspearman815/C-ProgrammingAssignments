Last login: Mon Oct 31 14:25:36 on ttys001
aspearman@Amaras-MacBook-Pro ~ % ssh aspearman2@snowball.cs.gsu.edu
aspearman2@snowball.cs.gsu.edu's password: 
Last login: Mon Oct 31 14:25:49 2022 from c-76-122-125-207.hsd1.ga.comcast.net
   +
   |   GSU Computer Science
   |   Instructional Server
   |   SNOWBALL.cs.gsu.edu
   +
[aspearman2@gsuad.gsu.edu@snowball ~]$ ./loanCalcPtr
