Last login: Mon Oct 31 14:26:29 on ttys001
aspearman@Amaras-MacBook-Pro ~ % ssh aspearman2@snowball.cs.gsu.edu
aspearman2@snowball.cs.gsu.edu's password: 
Last login: Mon Oct 31 14:26:48 2022 from c-76-122-125-207.hsd1.ga.comcast.net
   +
   |   GSU Computer Science
   |   Instructional Server
   |   SNOWBALL.cs.gsu.edu
   +
[aspearman2@gsuad.gsu.edu@snowball ~]$ ./loanCalcStruct
Enter amount of loan: $ 2000
Enter Interest rate per year: 7.5
Enter number of payments: 6

Monthly payment should be 340.66
...
[aspearman2@gsuad.gsu.edu@snowball ~]$ 
